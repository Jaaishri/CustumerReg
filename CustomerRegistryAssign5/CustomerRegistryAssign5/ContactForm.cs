...
namespace CustomerRegistryAssign5
{
    public partial class ContactForm : Form
    {
        ...
        private void txtMailBusiness_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtMailBusiness_Validating(object sender, CancelEventArgs e)
        {
            System.Text.RegularExpressions.Regex rEMail = new System.Text.RegularExpressions.Regex(@"^[a-zA-Z][\w\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$");
            if (txtMailBusiness.Text.Length > 0)
            {
                if (!rEMail.IsMatch(txtMailBusiness.Text))
                {
                    MessageBox.Show("E-Mail expected", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtMailBusiness.SelectAll();
                    e.Cancel = true;
                }
            }
        ...
        private void txtMailPrivate_Validating(object sender, CancelEventArgs e)
        {
            System.Text.RegularExpressions.Regex rEMail = new System.Text.RegularExpressions.Regex(@"^[a-zA-Z][\w\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$");
            if (txtMailBusiness.Text.Length > 0)
            {
        ...
        //if (System.Text.RegularExpressions.Regex.IsMatch("[^0-9]", txtCellPhone.Text))
        //{
        //    MessageBox.Show("Numbers expected", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
