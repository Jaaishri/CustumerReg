...
namespace CustomerRegistryAssign5
{
    public partial class MainForm : Form
    {
        ...
        private void UpdateGUI()
        {
            ...
            listBox1.Items.AddRange(this.customerMngr.GetContactsInfo());
            lblID.Text = listBox1.Items.Count.ToString();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            //    InitializeComponent();
            //}
            if (CheckSelectedIndex() && customerMngr.DeleteContact(GetSelectedIndex()))
                UpdateGUI();
            else
